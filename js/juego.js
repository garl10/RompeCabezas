...
var instrucciones = ["Utilizar las flechas para mover las pieza", "Ordenar las piezas hasta alcanzar la imagen objetivo"];
...
function chequearSiGano() {
    var posicionGanadora = 1;
    for (i = 0; i < grilla.length; i++) {
        for (j = 0; j < grilla.length; j++) {
            if (grilla[i][j] !== posicionGanadora) {
                return false;
            }
            if (posicionGanadora < 10) {
                posicionGanadora++;
            }
            if (posicionGanadora == 10) {
                return true;
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    var posicionActual = grilla[filaPos1][columnaPos1];
    grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = posicionActual;
